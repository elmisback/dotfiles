...
#         highlighting:
#  algol_nu, native, vs, bw, emacs, colorful, rrt, rainbow_dash, vim, pastie, tango, igor, arduino, murphy, default, friendly, xcode, monokai, borland, paraiso-dark, perldoc, autumn, algol, abap, manni, lovelace, trac, paraiso-light, fruity
